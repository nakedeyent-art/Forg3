...
_Last updated: 2026-07-18 UTC (Codex session: v15 redeploy, multi-file document signing support)_
...
- `npm run play:internal -- .deploy/mobile/forg3-1.0-build3-play-release-20260718T145315Z.aab` uploaded Android versionCode `3` to Play track `internal` with release status `completed` through the Google Play Developer API on July 18, 2026.
...
- Current signed Android release AAB: `.deploy/mobile/forg3-1.0-build3-play-release-20260718T145315Z.aab` (SHA-256 `a0ba27a83ac9356851ea0335325609a2da803bb946b7dd83f4d894797c52f4c4`)
